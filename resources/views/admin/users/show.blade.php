            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">
                        <i class="ph ph-user me-2"></i>Profil Pengguna
                    </h5>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span class="text-muted"><i class="ph ph-envelope-simple me-2"></i>Email</span>
                            <span>{{ $user->email }}</span>
                        </li>
                        @if($user->phone)
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span class="text-muted"><i class="ph ph-phone me-2"></i>Telepon</span>
                            <span>{{ $user->phone }}</span>
                        </li>
                        @endif
                        @if($user->student_id)
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span class="text-muted"><i class="ph ph-identification-card me-2"></i>NIS/NIP</span>
                            <span>{{ $user->student_id }}</span>
                        </li>
                        @endif
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span class="text-muted"><i class="ph ph-calendar-dots me-2"></i>Bergabung</span>
                            <span>{{ $user->created_at->format('d M Y') }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span class="text-muted"><i class="ph ph-check-circle me-2"></i>Verifikasi Email</span>
        ...
        <div class="col-lg-8">
            @if($user->role->name == 'student')
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ph ph-book me-2"></i>Mata Pelajaran yang Diikuti ({{ $user->enrolledCourses->count() }})
                        </h5>
                    </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ph ph-file-text me-2"></i>Riwayat Ujian ({{ $user->examAttempts->count() }})
                        </h5>
                    </div>
                    <div class="card-body p-0">
                        ...
                        @else
                            <div class="text-center py-4">
                                <i class="ph ph-file-text text-muted" style="font-size: 3rem;"></i>
            ...
            @if($user->role->name == 'teacher')
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ph ph-chalkboard-teacher me-2"></i>Mata Pelajaran yang Diajar ({{ $user->taughtCourses->count() }})
                        </h5>
                    </div>
                    <div class="card-body p-0">
                        ...
                        @else
                            <div class="text-center py-4">
                                <i class="ph ph-chalkboard-teacher text-muted" style="font-size: 3rem;"></i>
            ...
            @if($user->role->name == 'admin')
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="ph ph-shield-check me-2"></i>Statistik Administrator
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded text-center">
                                    <i class="ph ph-users text-primary" style="font-size: 2rem;"></i>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded text-center">
                                    <i class="ph ph-book text-success" style="font-size: 2rem;"></i>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded text-center">
                                    <i class="ph ph-file-text text-warning" style="font-size: 2rem;"></i>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded text-center">
                                    <i class="ph ph-graduation-cap text-info" style="font-size: 2rem;"></i>
