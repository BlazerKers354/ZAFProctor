                    ...
                    <div class="card-body">
                        @if($question->type === 'multiple_choice')
                            <div class="d-flex align-items-center p-3 bg-light-success rounded">
                                <i class="ph-duotone ph-check-square text-success me-3" style="font-size: 32px;"></i>
                                <div>
                        ...
                        @else
                            <div class="d-flex align-items-center p-3 bg-light-info rounded">
                                <i class="ph-duotone ph-text-aa text-info me-3" style="font-size: 32px;"></i>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="mb-2">
                                        <label for="question_image" class="btn btn-sm btn-outline-primary">
                                            <i class="ph ph-upload me-1"></i>Pilih Gambar Baru
                                        </label>
